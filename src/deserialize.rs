...
fn deserialize_dielectric(v: &Value) -> Option<Rc<Material>>
{
    match v {
        &Value::Object(ref m) => {
            m["refraction_index"]
...
fn deserialize_lambertian(v: &Value) -> Option<Rc<Material>>
{
    match v {
        &Value::Object(ref m) => {
...
fn deserialize_material(v: &Value) -> Option<Rc<Material>>
{
    match v {
        &Value::Object(ref m) => {
...
fn deserialize_metal(v: &Value) -> Option<Rc<Material>>
{
    match v {
        &Value::Object(ref m) => {
            deserialize_vec3(&m["albedo"])
...
fn deserialize_mixture(v: &Value) -> Option<Rc<Material>>
{
    match v {
        &Value::Object(ref m) => {
